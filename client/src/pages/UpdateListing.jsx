...
function CreateListing() {
  ...
  const handleChange = (e) => {
    ...
    if (e.target.name === "ownType") {
      if (e.target.value !== "") {
        setFormData({ ...formData, ownType: e.target.value });
      }
    }
        ...
        <div className="flex flex-col gap-4 flex-1">
          ...
          <label>
            ...
            >
              ...
              {/* <option value="sellandrent">Both</option> */}
            </select>
          </label>
          ...
          <div className="flex flex-wrap gap-6">
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                max="10"
                required
                className="p-3 border border-gray-300 rounded-lg h-[2.2rem]"
                onChange={handleChange}
            ...
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                max="100000000000000"
                required
                className="p-3 border border-gray-300 rounded-lg w-[7rem] h-[2.7rem]"
                onChange={handleChange}
        ...
        <div className="flex flex-col flex-1 gap-4">
          <p className="font-semibold">
            ...
            <span className="font-normal text-gray-600 ml-2">
              Upto 6 images can be upload. The first image will be the cover.
            </span>
          </p>
